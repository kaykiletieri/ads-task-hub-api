...
export class ClassTokenService {
    ...
    constructor(
        ...
        @InjectRepository(ClassToken) private readonly classTokenRepository: Repository<ClassToken>,
    ) { }

    async generateClassToken(classId: string, expirationDate: Date): Promise<ClassToken> {
        ...
        const prefix = this.generatePrefix(classEntity.class_number, classEntity.period.period_number, classEntity.period.year);
    ...
    private generatePrefix(classNumber: number, periodId: number, year: number): string {
