...
export class ClassesController {
    ...
    async getAllClasses(@Query() query: PaginationQueryDto): Promise<{ data: ClassResponseDto[], total: number }> {
    ...
    async getClassesByPeriod(@Param('periodId') periodId: string): Promise<ClassResponseDto[]> {
