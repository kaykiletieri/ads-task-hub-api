...
export class TasksController {
  ...
  @ApiOperation({
    ...
    description:
      'Fetch all tasks with optional filters by user ID and task status.',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiOperation({
    ...
    description:
      'Create a new task and associate it with a user, class, and period.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Update the task details by ID.',
  })
  @ApiParam({
    name: 'id',
    description: 'ID of the task',
